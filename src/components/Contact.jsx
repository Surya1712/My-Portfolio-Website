...
const contactInfo = [
  ...
  { icon: MapPin, label: "Location", value: "Gandhinagar, Gujarat", href: "#" },
];
...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 lg:py-32 px-4 sm:px-6 relative overflow-hidden">
      {/* Background Effects */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {contactInfo.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                  className="flex items-center gap-4 p-5 glass-card rounded-2xl group hover:border-primary/50 transition-all duration-300"
                >
                  <div className="w-12 h-12 bg-gradient rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <div className="flex gap-3">
                  {socials.map((social) => (
                    <a
                      ...
                      className="w-12 h-12 glass-card rounded-xl flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/50 transition-all duration-300"
              ...
              {/* Map */}
              <div className="aspect-video glass-card rounded-2xl overflow-hidden">
                <iframe
            ...
            <div className="lg:col-span-3">
              <form onSubmit={handleSubmit} className="glass-card p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl h-full">
                ...
                <Button type="submit" size="lg" className="w-full bg-gradient hover:opacity-90 shadow-soft text-primary-foreground text-lg py-6">
